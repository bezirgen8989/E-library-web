  ...
  return (
    <>
      <div className={styles.headerDesktop}>
        ...
        <nav className={styles.headerNav}>
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>{localization?.menuItemHome}</span>
          </Link>
          <Link
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>
              {localization?.menuItemMyBookshelf}
            </span>
          </Link>
          <Link
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>
              {localization?.menuItemAskQuestion}
            </span>
          </Link>
          <Link
      ...
      <div className={styles.headerMobile}>
        ...
        <div className={styles.pageTitle}>{localization?.menuItemHome}</div>
        <div className={styles.headerNotifications} onClick={showDrawer}>
          {hasNotifications && <div className={styles.dot} />}
          <img src={bell} alt="bell" />
        </div>
