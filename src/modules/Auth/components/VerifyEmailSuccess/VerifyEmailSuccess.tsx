        ...
        <div style={{display: "flex", width: '100%', height: '100vh', position: 'relative'}}>
            <div className={commonStyles.centeredWrapper}>
                ...
                <div className={commonStyles.centered}>
                    ...
                    <div className={commonStyles.success_subtitle}>Email on how to reset your password has been sent to
                        davidm1970@gmail.com. Please follow instructions.
                    </div>
                    <Button variant="Transparent" to="/onboarding">Back to Home</Button>
                </div>
