      ...
      <div className={commonStyles.centeredWrapper}>
        ...
        <div className={commonStyles.centered}>
          ...
          <form onSubmit={handleSubmit(onSubmitForm)}>
            ...
            <Button variant="White" type="submit">Create Account</Button>
          </form>
        </div>
          ...
          <div>
            <div className={commonStyles.login_subtitle} style={{marginBottom: "15px"}}>
              <div style={{textAlign: "center"}}>
                By creating an account you agree<br/> to our <Link style={{color: "#FFEA84", marginLeft: 8}} to="">Terms
                and Conditions</Link><br/>
                and
                <Link style={{color: "#FFEA84", marginLeft: 8}} to="">Privacy Policy</Link>.
              </div>
            </div>
          </div>
        </div>
