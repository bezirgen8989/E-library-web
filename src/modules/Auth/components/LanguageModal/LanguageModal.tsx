...
const LanguageModal:FC <LanguageModalProps> = ({isModalOpen, setIsModalOpen, languages, defaultLanguage,  onLanguageSelect}) => {
    ...
    const handleLanguageSelect = (lang: LanguageType) => {
        ...
        onLanguageSelect(lang); // Update selected language in ProfileForm
        hideModal();
    };
    ...
    return (
        <Modal
            ...
            footer={null}
            closeIcon={<img className={commonStyles.modalCloseIcon} src={Close} alt="close-icon"/>}
        >
            <Input
                placeholder="Search"
            ...
            <div className={commonStyles.languageList}>
                {filteredLanguages.map((lang: LanguageType) => (
                    <div
                        key={lang.id}
                        className={`${commonStyles.languageItem} ${lang.name === selectedLanguage.name ? commonStyles.active : ""}`}
