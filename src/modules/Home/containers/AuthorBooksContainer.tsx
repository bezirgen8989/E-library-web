...
import {getAuthorsBooks, getBookById, getNameByAuthorId} from "../slices/home";
import {routes} from "../routing";
import {useHistory, useParams} from "react-router-dom";
import AuthorsBooksComponent from "../components/AllBooksComponents/AuthorBooksComponent";
...
const AuthorBooksContainer: React.FC = () => {
    ...
    console.log("newBooks", authorBooks)
