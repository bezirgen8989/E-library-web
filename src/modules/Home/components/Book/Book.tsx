...
const Book: React.FC<HomeProps> = ({
    ...
    useEffect(() => {
        if (currentBook?.result) {
            setBook(currentBook.result);
            console.log("Current Book Set:", currentBook.result);
        }
    }, [currentBook]);
            ...
            <div className={styles.home_page}>
                <div className={styles.flex_wrap}>
                    <div className={styles.left_side}>
                        <Skeleton.Image style={{width: "247px", height: "372px", marginBottom: '20px'}}/>
                        <Skeleton active paragraph={{rows: 1}} title={false}/>
                    </div>
                    <div className={styles.right_side}>
                        <div style={{marginBottom: '20px'}}><Skeleton.Button active/></div>
                        <div style={{marginBottom: '40px', width: '300px'}}><Skeleton.Button active block/></div>
                        <div style={{display: "flex", justifyContent: "space-between"}}>
                            <Skeleton.Button style={{marginBottom: '20px', width: "95%", height: "54px"}} active block/>
                            <Skeleton.Button style={{marginBottom: '20px', width: "95%", height: "54px"}} active block/>
                        </div>
                        <Skeleton.Button style={{marginBottom: '20px'}} active block/>
                        <Skeleton.Button style={{marginBottom: '20px', height: '80px'}} active block/>
                        <Skeleton.Button style={{marginBottom: '20px', height: '60px'}} active block/>
                        <Skeleton.Button style={{marginBottom: '20px', height: '60px'}} active block/>
                    </div>
                </div>
            </div>
    ...
    return (
        <div>
            <div onClick={() => history.goBack()} className={styles.backBtnRelativePage}>
            ...
            <div className={styles.home_page}>
                <div className={styles.flex_wrap}>
                        ...
                        <div className={styles.desktopView}>
                            ...
                            <div style={{
                                ...
                                {book?.categories?.map((category: any) => (
                                    <div key={category.id} style={{background: category.color}}
                                         className={styles.habit_tag}>
                                        <img style={{marginRight: "5px"}} src={HabitIcon} alt="icon"/>
                                        {category.name}
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className={styles.right_side}>
                        <div className={styles.top_block}>
                            <div className={styles.book_title}>
                                ...
                                <div className={styles.bookSettings}>
                                    ...
                                    <div className={styles.bookShelfButton} onClick={handleLikeClick}>
                                        <img
                                            src={LikeIcon}
                                            alt="like"
                            ...
                            {book?.author?.map((author: any, index: number) => {
                                ...
                                return (
                                    <React.Fragment key={index}>
                                        ...
                                        {isSecondLast && <span style={{color: "#7C7A72"}}> and </span>}
                                        {!isSecondLast && !isLast && ", "}
                                    </React.Fragment>
                                );
                            })}
                        ...
                        <div className={styles.btns_block}>
                            <Button className={styles.readBtn} variant="Brown" type="submit">Read Now</Button>
                        ...
                        <section className={styles.reviewsSection}>
                            ...
                            >
                                Write a review
                                <img style={{marginLeft: "10px"}} src={ReviewIcon} alt="icon"/>
                            </Button>
                        </section>
                        <section>
                            <PageBooksList
                ...
                />
                <ReviewModal reviewSubmit={reviewSubmit} book={book} isModalOpen={isReviewModalOpen}
